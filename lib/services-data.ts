...
export const servicesData: ServiceData[] = [
  {
    ...
    category: "Дизайн",
    categorySlug: "design",
    description: "Создаём сайты, которые не просто красиво выглядят, но и решают бизнес-задачи. Каждый пиксель служит цели: привлечь внимание, удержать клиента и конвертировать посетителя в покупателя.",
    icon: Monitor,
    features: [
      { title: "Лендинги", description: "Продающие одностраничные сайты с чёткой структурой и мощным CTA.", icon: Layers },
      { title: "Корпоративные сайты", description: "Многостраничные порталы с удобной навигацией и каталогами.", icon: Globe },
      { title: "Адаптивный дизайн", description: "Идеальное отображение на любых устройствах: от смартфона до 4K монитора.", icon: Smartphone },
      { title: "Дизайн-системы", description: "Набор компонентов для масштабирования продукта без потери качества.", icon: Palette },
    ],
    process: [
      { step: "01", title: "Исследование", description: "Изучаем бизнес, целевую аудиторию и конкурентов." },
      { step: "02", title: "Прототипирование", description: "Создаём структуру страниц (wireframes) для удобной навигации." },
  ...
  },
  {
    ...
    category: "Дизайн",
    categorySlug: "design",
    description: "Проектируем интерфейсы, в которых каждый элемент продуман. Пользователь находит то, что нужно, за секунды, а взаимодействие с продуктом приносит удовольствие.",
    icon: Palette,
    features: [
      { title: "CJM и User Flow", description: "Картируем путь пользователя от первого контакта до целевого действия.", icon: Layers },
      { title: "Wireframing", description: "Создаём низко- и высокодетальные прототипы для тестирования логики.", icon: PenTool },
      { title: "Юзабилити-аудит", description: "Находим барьеры в текущем интерфейсе, которые отпугивают клиентов.", icon: Lightbulb },
      { title: "Интерактивные прототипы", description: "Кликабельные модели для тестирования до начала разработки.", icon: Smartphone },
    ],
    process: [
  ...
  },
  {
    ...
    category: "Дизайн",
    categorySlug: "design",
    description: "Строим визуальную идентичность, которая выделяет вас среди конкурентов и запоминается с первого взгляда. Бренд — это не логотип, это эмоция, которую вы вызываете.",
    icon: Layers,
    features: [
      { title: "Логотип и фирменный знак", description: "Создаём уникальный символ, который становится лицом компании.", icon: Palette },
      { title: "Брендбук", description: "Полное руководство по использованию фирменного стиля.", icon: Globe },
      { title: "Айдентика", description: "Дизайн носителей: визитки, пакеты, мерч, сувениры.", icon: Monitor },
      { title: "Нейминг и слоган", description: "Подбираем название и фразу, отражающие суть бренда.", icon: PenTool },
    ],
    process: [
      { step: "01", title: "Бриф и Глубинное интервью", description: "Погружаемся в ценности, миссию и характер компании." },
      { step: "02", title: "Концепция", description: "Разрабатываем 2-3 визуальных направления для выбора." },
      { step: "03", title: "Доработка и гайдлайны", description: "Упаковываем выбранную концепцию в правила бренда." },
    ],
    benefits: [
  ...
  },
  {
    ...
    category: "Дизайн",
    categorySlug: "design",
    description: "Дизайн приложений для iOS и Android, учитывающий платформенные гайдлайны и особенности взаимодействия пальцами, а не мышкой.",
    icon: Smartphone,
    features: [
  ...
  },
  {
    ...
    description: "Превращаем дизайн в быстрый, отзывчивый и живой интерфейс. Используем современный стек для обеспечения молниеносной загрузки и плавных анимаций.",
    icon: Code,
    features: [
  ...
  },
  {
    ...
    category: "Разработка",
    categorySlug: "development",
    description: "Создаём надёжный серверный фундамент: API, базы данных, интеграции. Ваш продукт выдержит любую нагрузку и будет защищён от сбоев.",
    icon: Shield,
    features: [
  ...
  },
  {
    ...
    category: "Разработка",
    categorySlug: "development",
    description: "Упаковываем сайты в удобные системы управления контентом. Вы сможете сами менять тексты, добавлять товары и публиковать статьи без помощи программиста.",
    icon: Globe,
    features: [
  ...
  },
  {
    ...
    description: "Выводим сайты в топ поисковых систем по целевым запросам. Работаем с белыми методами, которые обеспечивают стабильный поток клиентов из Яндекс и Google.",
    icon: BarChart3,
    features: [
  ...
  },
  {
    ...
    category: "Маркетинг",
    categorySlug: "marketing",
    description: "Тексты, которые продают, и статьи, которые сохраняют. Разрабатываем контент, который вовлекает аудиторию, формирует экспертность и ведёт к покупке.",
    icon: PenTool,
    features: [
  ...
  },
  {
    ...
    category: "Маркетинг",
    categorySlug: "marketing",
    description: "Превращаем данные в решения. Настраиваем сквозную аналитику, чтобы вы точно знали, какой канал приносит деньги, а какой сжигает бюджет.",
    icon: Lightbulb,
    features: [
  ...
  },
  {
    ...
    category: "Маркетинг",
    categorySlug: "marketing",
    description: "Ваш сайт всегда в строю. Регулярные обновления, защита от взломов, резервное копирование и оперативное решение любых технических проблем.",
    icon: Headphones,
    features: [
