    ...
    <>
      <style jsx>{`
        ...
        .glow-container {
          ...
          --card-radius: 1.5rem;
          --card-width: var(--modal-width, 480px);
          --border-width: 3px;
          --bg-size: 1;
          --hue: 0;
          --hue-speed: 1;
        ...
        .glow-container:after {
          ...
          height: 100%;
          border-radius: var(--card-radius);
          pointer-events: none; /* ИСПРАВЛЕНИЕ: запрещаем клики по декорациям */
        }
        ...
        .glow-content {
          ...
          width: 100%;
          height: 100%;
          z-index: 10; /* ИСПРАВЛЕНИЕ: поднимаем контент выше всех декораций */
          pointer-events: auto; /* ИСПРАВЛЕНИЕ: разрешаем клики по контенту */
        }
        ...
        .glow-content:before {
          ...
          z-index: -1;
          pointer-events: none; /* ИСПРАВЛЕНИЕ: запрещаем клики */
        ...
        .glow {
          ...
          display: block;
          position: absolute;
          pointer-events: none; /* ИСПРАВЛЕНИЕ: запрещаем клики по орбите */
